...
/*
 ...
 테이블 생성하기 > 스키마 정의하기 > 컬럼 정의하기 > 컬럼의 이름, 자료형, 제약을 정의 
  ...
  2. PRIMARY KEY,PK
  	...
  	- 중복값을 가질 수 없다. > unique
  	- 값을 반드시 가진다. > 값을 생략할 수 없다 > NOT NULL
...
INSERT INTO tblmemo (seq, name, memo, regdate) VALUES (2, '홍길동', '', sysdate); --빈문자('') -빈문자도 NULL로 취급한다.
...
(
	...
	regdate DATE, 					--작성날짜
	--priority NUMBER(1) CHECK (priority >= 1 AND priority <= 3),				--중요도 1-중요 2-보통 3-안중요
...
-- ORA-02290: check constraint (HR.SYS_C007185) violated
INSERT INTO tblmemo (seq, name, memo, regdate, priority, category) VALUES (2, '홍길동', '메모입니다.', sysdate, 5, '할일');

-- ORA-02290: check constraint (HR.SYS_C007186) violated
...
INSERT INTO tblmemo (seq, name, memo, regdate) VALUES (4, default, '메모입니다.', default); -- dafault 상수
