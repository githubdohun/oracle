...
-- 내부조인
-- 업무 > 물건을 한번이라도 구매 한 이력이 있는 고객의 정보와 그 고객이 사 간 구매내역을 가져오시오.
SELECT 
	*
FROM tblcustomer c
	INNER JOIN tblsales s
...
FROM tblcustomer c
	LEFT OUTER JOIN tblsales s
		ON c.seq = s.cseq;	-- 11개 INNER JOIN 목록을 가져오고, 해당 되지 않은 seq를 같이 출력해준다?
...
FROM tblcustomer c
	right OUTER JOIN tblsales s
		ON c.seq = s.cseq;	-- 9개 내부 조인과 동일한 결과
...
INSERT INTO tblself (seq, name, department, super) VALUES (1, '홍사장', '사장', null);
INSERT INTO tblself (seq, name, department, super) VALUES (2, '김부장', '영업부',1);
INSERT INTO tblself (seq, name, department, super) VALUES (3, '박과장', '영업부',2);
INSERT INTO tblself (seq, name, department, super) VALUES (4, '최대리', '영업부',3);
INSERT INTO tblself (seq, name, department, super) VALUES (5, '정사원', '영업부',4);
INSERT INTO tblself (seq, name, department, super) VALUES (6, '이부장', '개발부',1);
INSERT INTO tblself (seq, name, department, super) VALUES (7, '하과장', '개발부',6);
INSERT INTO tblself (seq, name, department, super) VALUES (8, '신과장', '개발부',6);
INSERT INTO tblself (seq, name, department, super) VALUES (9, '황대리', '개발부',7);
INSERT INTO tblself (seq, name, department, super) VALUES (10, '허사원', '개발부',9);
